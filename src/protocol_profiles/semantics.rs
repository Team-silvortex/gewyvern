...
pub(super) fn built_in_protocol_entry_semantics(
    ...
    match protocol {
        ...
        "tftp" => transport::tftp_entry_semantics(entry),
        "dhcp" => discovery::dhcp_entry_semantics(entry),
        "dhcpv6" => discovery::dhcpv6_entry_semantics(entry),
        ...
        "syslog" => telemetry::syslog_entry_semantics(entry),
        ...
        "llmnr" => discovery::llmnr_entry_semantics(entry),
        "nbns" => discovery::nbns_entry_semantics(entry),
