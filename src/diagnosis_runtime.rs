...
pub(crate) use self::render::{
    ...
    append_external_sidecar_context_json, append_process_network_profiles_json_from_snapshot,
...
pub(crate) use self::status::{
    ScanTargetStatus, analysis_augmentation_names_text, external_sidecar_presence,
    protocol_flow_has_terminal_failure, protocol_flow_last_phase, protocol_flow_phases,
    scan_target_status, suspect_modules_json_from_snapshot,
};
