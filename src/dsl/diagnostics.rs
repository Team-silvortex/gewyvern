pub(super) fn pipeline_available_steps_message() -> &'static str {
...
pub(super) fn pipeline_declared_functions_message(function_names: &[String]) -> String {
...
pub(super) fn pipeline_declared_params_message(
...
pub(super) fn pipeline_scope_names_message(context: &str, names: &[String]) -> String {
    if names.is_empty() {
...
pub(super) fn pipeline_unknown_placeholder_message(
    context: &str,
    key: &str,
    names: &[String],
) -> String {
...
pub(super) fn pipeline_declared_kind_conflict_message(
    function_signature: &str,
    param_name: &str,
    declared_kind: &str,
    inferred_kind: &str,
...
pub(super) fn pipeline_inferred_kind_conflict_message(
    function_signature: &str,
    param_name: &str,
    left_kind: &str,
    right_kind: &str,
