...
This roadmap treats `v1.12.x` as the active post-1.0 stable line, with
`v1.12.2` as the current shared release.
...
- current documented checkpoint: `v1.12.2`
- active line: `v1.12.x` reliability work and Rust control-plane delivery
...
## What `v1.12.x` Means Right Now

At the current `v1.12.2` checkpoint, the active line should be interpreted as:
...
### 1. `v1.12.x`: Reliability And Operating Confidence
