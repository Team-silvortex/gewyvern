...
This note records the highest-signal findings inherited by the active `1.10.x` line
...
The `1.10.x` validation CLI now consumes synchronized Linux-host evidence with
...
The current `1.10.x` line inherits strength in these areas:
