...
This note records the highest-signal findings inherited by the active `1.5.0` line
...
The `1.5.0` validation CLI now consumes synchronized Linux-host evidence with
...
The current `1.5.0` line inherits strength in these areas:
