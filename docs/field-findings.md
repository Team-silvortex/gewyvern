...
This note records the highest-signal findings inherited by the active `2.0.x` line
...
The `2.0.x` validation CLI now consumes synchronized Linux-host evidence with
...
The current `2.0.x` line inherits strength in these areas:
