...
This note records the highest-signal findings inherited by the active `1.4.6` line
...
The `1.4.6` validation CLI now consumes synchronized Linux-host evidence with
...
The current `1.4.6` line inherits strength in these areas:
