...
- current release judgment for the active `1.4.0` line
...
Keep the current `1.4.0` field-validation line intentionally narrow.
...
It exists so the active `1.4.0` line has a concrete "keep validating for
real" shelf rather
