...
- current release judgment for the active `1.4.6` line
...
Keep the current `1.4.6` field-validation line intentionally narrow.
...
It exists so the active `1.4.6` line has a concrete "keep validating for
real" shelf rather
