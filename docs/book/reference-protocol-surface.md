...
- Family/default map:
  ...
  - `bgp` -> default `open` in cluster `network-control-discovery` via [docs/book/reference-bgp-surface.md](/Users/Shared/chroot/dev/gewyvern/docs/book/reference-bgp-surface.md)
