...
Before selecting the file, active `1.4.6` startup prepares the standard runtime
...
This policy surface is intentionally conservative. In the active `1.4.6`
line it highlights:
...
The current `1.4.6` startup behavior now pairs this config contract with a
