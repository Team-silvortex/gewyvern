...
the documentation set coherent as the `0.19.x` line approaches `1.0.0`.
...
During the active `1.15.x` line, documentation changes should bias toward:
...
- `v0.13.x`
- `v0.15.x`
- current and future lines such as `v1.15.x` when those lines actually begin
