...
the documentation set coherent as the `0.15.x` line evolves.
...
During the current `0.15.x` line, documentation changes should bias toward:
...
- does it help the `0.15.x` line feel more whole?
