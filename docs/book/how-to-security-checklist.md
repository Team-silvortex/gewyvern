...
It is a practical operator checklist for the active `1.15.x` runtime shape.
...
Current `1.15.x` safety behavior:
...
If all eight are true, you are aligned with the current `1.15.x` security shape.
