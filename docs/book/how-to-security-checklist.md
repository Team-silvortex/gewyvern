...
It is a practical operator checklist for the active `1.2.0` runtime shape.
...
If all eight are true, you are aligned with the current `1.2.0` security shape.
