...
It is a practical operator checklist for the active `1.4.0` runtime shape.
...
If all eight are true, you are aligned with the current `1.4.0` security shape.
