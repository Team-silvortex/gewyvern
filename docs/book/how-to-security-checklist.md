...
It is a practical operator checklist for the active `2.1.x` runtime shape.
...
If all eight are true, you are aligned with the current `2.1.x` security shape.
