...
It is a practical operator checklist for the active `1.7.x` runtime shape.
...
If all eight are true, you are aligned with the current `1.7.x` security shape.
