# Reference: Protocol Release Handbook For `2.0.x`
...
This page is the protocol-facing release handbook for the active `2.0.x`
line.
...
- “what protocol evidence should still exist before we call `2.0.x` green?”
...
These are the shortest family-level checks worth keeping alive in `2.0.x`:
...
- “is this good enough for a `2.0.x` ship read?”
