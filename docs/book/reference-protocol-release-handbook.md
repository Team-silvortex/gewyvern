# Reference: Protocol Release Handbook For `1.20.x`
...
This page is the protocol-facing release handbook for the active `1.20.x`
line.
...
- “what protocol evidence should still exist before we call `1.20.x` green?”
...
These are the shortest family-level checks worth keeping alive in `1.20.x`:
...
- “is this good enough for a `1.20.x` ship read?”
