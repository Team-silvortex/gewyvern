...
The standard config file name for the active `1.5.0` line is:
...
The current `1.5.0` expectation is:
...
The current `1.5.0` history retention rule is intentionally simple:
...
In the current `1.5.0` line those JSON artifacts may include:
