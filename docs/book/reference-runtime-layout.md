...
The standard config file name for the active `1.17.x` line is:
...
The current `1.17.x` expectation is:
...
The current `1.17.x` history retention rule is intentionally simple:
...
In the current `1.17.x` line those JSON artifacts may include:
