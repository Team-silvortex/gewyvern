...
The standard config file name for the active `1.4.6` line is:
...
The current `1.4.6` expectation is:
...
The current `1.4.6` history retention rule is intentionally simple:
...
In the current `1.4.6` line those JSON artifacts may include:
