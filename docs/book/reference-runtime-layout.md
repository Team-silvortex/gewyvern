...
The standard config file name for the active `1.15.x` line is:
...
The current `1.15.x` expectation is:
...
The current `1.15.x` history retention rule is intentionally simple:
...
In the current `1.15.x` line those JSON artifacts may include:
