...
- current release line: `v1.12.x`, with `v1.12.2` as the current shared release
...
The `1.0.0` seal established the trust baseline. The `1.12.x` line preserves
