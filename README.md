...
- current release line: `v1.14.x`, with `v1.14.0` as the current shared release
...
The `1.0.0` seal established the trust baseline. The `1.14.x` line preserves
