...
- current release line: `v1.10.x`, with `v1.10.0` as the current shared release
...
The `1.0.0` seal established the trust baseline. The `1.10.x` line preserves
