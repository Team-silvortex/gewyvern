use super::{
    PipelineCall, PipelineLetBinding, PipelineParam, PipelineValueKind, SyntaxError as DslError,
    diagnostics::{
...
pub fn pipeline_value_kind_text(kind: PipelineValueKind) -> &'static str {
    match kind {
...
pub fn format_pipeline_function_signature(function_name: &str, params: &[PipelineParam]) -> String {
    let params = params
        .iter()
