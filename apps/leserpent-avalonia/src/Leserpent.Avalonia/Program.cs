    ...
    public static int Main(string[] args)
    {
            ...
            var languagePackRoot])
        {
            DesktopLanguagePackCatalogClient.VerifyPublishedArtifacts(
                ...
                languagePackRoot);
            Console.WriteLine(
                "published desktop language packs valid: catalog_schema=v1, downloadable_locales=22, core_ui_keys=18, sha256=true, locale_version_binding=true, native_store_roundtrip=true");
            return 0;
        }
