...
internal static class Program
{
    ...
    public static int Main(string[] args)
    {
        ...
        if (args is ["--verify-orchestra-client"])
        {
            ...
            Console.WriteLine(
                "Orchestra client valid: rust_authority=true, authenticated_wire=true, history=true, event_history=true, idempotent_cleanup=true, strict_decode=true, identity_fenced=true, bounded=true");
            return 0;
        }
